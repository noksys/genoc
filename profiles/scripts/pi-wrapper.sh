...
#
# Wraps: npx -y @earendil-works/pi-coding-agent@latest  (pi coding agent — harness used by Tamandua)
# NOTE: @mariozechner/pi-coding-agent was deprecated in favour of @earendil-works/*.
# The latest requires Node >= 22 (there is a legacy-node20 dist-tag for older setups).
