...
in
{
  ...
  mainUser = mainUser;
  plymouthTheme = "rings_2";
  # Use: mkpasswd -m sha-512
  rootHashedPassword = "$6$CHANGE-ME$XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
  ...
  userHashedPassword = "$6$CHANGE-ME$XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
  paisaAuth = "admin:$apr1$I.kbKCjq$Ls4LP5ZMOyDkYVvncPcos/";
}
